				...
				<div className="space-y-8">
					...
					<div>
						<ul className="mt-3">
							...
							{/* Betentry */}
							<li
								className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes("/app/betentry") && "bg-slate-900"}`}
							>
								<NavLink
									end
									to="/app/betentry"
									className={`block text-slate-200 truncate transition duration-150 ${
										pathname.includes("/app/betentry")
											? "hover:text-slate-200"
											: "hover:text-white"
									}`}
								>
									<div className="flex items-center justify-between">
										<div className="grow flex items-center">
											<svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
												<path
													className={`fill-current ${pathname.includes("/app/betentry") ? "text-indigo-500" : "text-slate-600"}`}
													d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"
												/>
												<path
													className={`fill-current ${pathname.includes("/app/betentry") ? "text-indigo-300" : "text-slate-400"}`}
							...
							{/* Customer */}
							<li
								className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes("/app/bettrack") && "bg-slate-900"}`}
							>
								<NavLink
									end
									to="/app/bettrack"
									className={`block text-slate-200 truncate transition duration-150 ${
										pathname.includes("/app/bettrack")
											? "hover:text-slate-200"
											: "hover:text-white"
									}`}
								>
										...
										<div className="grow flex items-center">
											...
											>
												<g fill="none" fillRule="evenodd" stroke="#4A4A4A">
													<circle
														className={`fill-current ${pathname.includes("/app/bettrack") ? "text-indigo-500" : "text-slate-400"}`}
														cx="7.933"
														cy="7.733"
														r="2.667"
													></circle>
													<path
														className={`fill-current ${pathname.includes("/app/bettrack") ? "text-indigo-500" : "text-slate-600"}`}
														strokeLinecap="round"
							...
							{/* Accounts */}
							<li
								className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes("/app/plrecord") && "bg-slate-900"}`}
							>
								<NavLink
									end
									to="/app/plrecord"
									...
									<div className="flex items-center justify-between">
										<div className="grow flex items-center">
											...
											>
												<defs>
													<path
														className={`fill-current ${pathname.includes("/app/plrecord") ? "text-indigo-500" : "text-slate-600"}`}
														id="b"
							...
							{/* performance */}
							<li
								className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes("/app/performance") && "bg-slate-900"}`}
							>
								<NavLink
									end
									to="/app/performance"
									className={`block text-slate-200 truncate transition duration-150 ${
										pathname.includes("/app/performance")
											? "hover:text-slate-200"
											: "hover:text-white"
									}`}
								>
									<div className="flex items-center justify-between">
										<div className="grow flex items-center">
											...
											>
												<path
													className={`fill-current ${pathname.includes("/app/performance") ? "text-indigo-500" : "text-slate-400"}`}
